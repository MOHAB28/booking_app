...
class ExploreScreen extends StatefulWidget {
  ...
  ExploreScreen({Key? key, required this.animationController})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<GetHotelsCubit , GetHotelsState>(
      ...
      builder: (context, state) {
        if (BlocProvider.of<GetHotelsCubit>(context)
            .hotelsEntity != null) {
              ...
              children: [
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: 4,
                    padding:
                    EdgeInsets.only(top: sliderImageHeight + 32, bottom: 16),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (index == 0) {
                        ...
                        // BEST DEAL SECTION
                        var bloc = BlocProvider.of<GetHotelsCubit>(context).hotelsEntity!.getAllHotelsData.getHotelData;
                        return getDealListView( bloc ,index);
                      }
                    },
                  ),
                ),
                SliderDesign(animationController: animationController,),
